...
<head>
    ...
    <title>Equipo registrado – {{ $team->name }}</title>
    <style>
                    ...
                    <tr>
                        <td style="background: #ffffff; padding: 44px 48px 36px;">
                            ...
                            <h1 style="font-family:'Bebas Neue', Impact, sans-serif; font-size: 28px;
                                       ...
                                       margin: 0 0 8px;">
                                ¡BIENVENIDO <span style="color:#10b77f;">{{ mb_strtoupper($team->name) }}</span>!
                            </h1>
                            ...
                            <p style="font-size: 15px; color: #4a5c4d; line-height: 1.7; margin: 0 0 24px;">
                                Te confirmamos que el equipo
                                <strong style="color: #10b77f;">{{ $team->name }}</strong>
                                ha sido registrado exitosamente en la plataforma.
                                Ahora podrás inscribirlo en los torneos disponibles.
                            </p>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td style="padding: 4px 0;">
                                                    ...
                                                    <span style="display: block; font-size: 18px; color: #0d1a0f; font-weight: 700;">{{ $team->name }}</span>
                                                </td>
                                            </tr>
                                            @if ($team->colors)
                                            <tr>
                                                <td style="padding: 4px 0;">
                                                    <span style="font-size: 13px; color: #6b7a6e; font-weight: 600; letter-spacing: 1px; text-transform: uppercase;">Colores</span>
                                                    <span style="display: block; font-size: 18px; color: #0d1a0f; font-weight: 700;">{{ $team->colors }}</span>
                                                </td>
                                            </tr>
                                            @endif
                                            @if ($team->delegado)
                                            <tr>
                                                <td style="padding: 4px 0;">
                                                    <span style="font-size: 13px; color: #6b7a6e; font-weight: 600; letter-spacing: 1px; text-transform: uppercase;">Responsable</span>
                                                    <span style="display: block; font-size: 18px; color: #0d1a0f; font-weight: 700;">{{ $team->delegado->name }}</span>
                                                </td>
                                            </tr>
                                            @endif
                                        </table>
                        ...
                        <td style="background: #0a2212; border-radius: 0 0 16px 16px; padding: 24px 40px;
                            ...
                            <div style="display: inline-block; background: #0f3d1e; border: 1px solid #10b77f40;
                                ...
                                <span style="font-family:'Bebas Neue', Impact, sans-serif; font-size: 20px;
                                    ...
                                    PLATAFORMA &nbsp;<span style="color:#10b77f;">—</span>&nbsp; {{ date('Y') }}
                                </span>
                            </div>
