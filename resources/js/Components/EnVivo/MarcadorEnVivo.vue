...
<template>
    <div class="flex items-center justify-center gap-6 md:gap-10 py-6">
        <!-- Local -->
        <div class="flex flex-col items-center gap-3 text-center w-32">
            <div
                class="h-16 w-16 md:h-20 md:w-20 rounded-2xl bg-slate-100 dark:bg-white/5 bg-cover bg-center border-2 border-slate-200 dark:border-slate-700"
        ...
        <div class="flex flex-col items-center gap-1">
            <div class="flex items-center gap-3 md:gap-5">
                <span class="text-4xl md:text-6xl font-black text-slate-900 dark:text-white tabular-nums">
                    {{ partido?.goles_local ?? 0 }}
                </span>
                <span class="text-xl md:text-3xl font-black text-slate-300 dark:text-slate-600">—</span>
                <span class="text-4xl md:text-6xl font-black text-slate-900 dark:text-white tabular-nums">
