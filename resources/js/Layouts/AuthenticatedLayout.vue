        ...
        >
            ...
            >
                ...
                >
                    ...
                    <span
                        class="text-primary text-[10px] font-bold uppercase tracking-[0.2em]"
                        >League Manager</span
                    >
                </div>
            </div>
            ...
            >
                ...
                >
                    <span
                        class="material-symbols-outlined shrink-0 transition-transform group-hover:scale-110"
                        >dashboard</span
                    >
                    <span
                        :class="[
                ...
                <div class="space-y-1">
                    ...
                    >
                        <div
                            v-show="openMenus.planes && !isDesktopCollapsed"
                ...
                <div class="space-y-1">
                    ...
                    >
                        ...
                        >
                            <Link
                                href="#"
                                class="block py-2 text-xs font-medium text-slate-500 hover:text-primary transition-colors whitespace-nowrap"
                            >
                                Gestión de Ligas
                            </Link>
                            <Link
                ...
                >
                    <span
                        class="material-symbols-outlined shrink-0 group-hover:text-primary transition-colors"
                        >{{ item.i }}</span
                    >
                    <span
                        :class="[
            ...
            <div
                class="p-4 border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-black/10 shrink-0"
            >
                <div class="flex items-center gap-3">
                    <div
                        class="h-10 w-10 rounded-xl bg-primary text-white flex items-center justify-center font-bold shadow-lg shadow-primary/20 shrink-0"
                    >
                    ...
                    >
                        ...
                        <p
                            class="text-[10px] text-primary font-bold uppercase tracking-tighter"
                        >
                            Plan Premium
                        </p>
                    </div>
        ...
        <div class="flex flex-1 flex-col overflow-hidden">
            ...
            >
                <div class="flex items-center gap-4">
                    ...
                    <div
                        class="hidden sm:flex items-center gap-2 text-xs font-bold text-slate-400 uppercase tracking-widest transition-all"
                    >
                        <span>App</span>
                        ...
                        >
                        <span
                            class="text-slate-900 dark:text-white transition-colors"
                            >{{ $page.component }}</span
                        >
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div
                        class="h-8 w-px bg-slate-200 dark:bg-slate-800 mx-1"
                    ></div>
                    ...
                    <Dropdown align="right" width="48">
                        <template #trigger>
                            ...
                            >
                                <div
                                    class="hidden md:flex flex-col items-end transition-all"
                                >
                                    <span
                                ...
                                <span
                                    class="material-symbols-outlined text-slate-400 group-hover:rotate-180 transition-transform duration-300"
                                    >expand_more</span
                                >
                            </button>
                        </template>
