            ...
            <nav class="flex-1 overflow-y-auto p-4 space-y-2 custom-scrollbar overflow-x-hidden">
                ...
                <Link :href="route('teams.index')"
                    ...
                    <div class="relative">
                        ...
                        <span v-if="isRouteActive('teams.*')" class="absolute -top-1 -right-1 flex h-2 w-2">
                            <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-75"></span>
                            <span class="relative inline-flex rounded-full h-2 w-2 bg-primary"></span>
                        </span>
                    </div>
                ...
                <!-- Enlace: Árbitros -->
                <Link :href="route('arbitros.index')"
                    :class="[isRouteActive('arbitros.*')
                        ? 'bg-primary/10 text-primary border border-primary/20 shadow-sm shadow-primary/5'
                        : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-white/5']"
                    class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all group">
                    <div class="relative">
                        ...
                        <span v-if="isRouteActive('arbitros.*')" class="absolute -top-1 -right-1 flex h-2 w-2">
                            <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-75"></span>
                            <span class="relative inline-flex rounded-full h-2 w-2 bg-primary"></span>
                        </span>
                    </div>
