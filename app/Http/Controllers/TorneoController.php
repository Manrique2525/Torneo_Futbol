...
class TorneoController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'precio_inscripcion' => 'nullable|numeric|min:0|max:999999.99',
            'pago_requerido' => 'boolean',
            'baja_por_impago_automatica' => 'boolean',
            'max_jornadas_sin_pago' => 'nullable|integer|min:1|max:99',
    ...
    public function update(Request $request, Torneo $torneo): RedirectResponse
    {
        ...
        $torneo->update([
            ...
            'baja_por_impago_automatica' => $request->boolean('baja_por_impago_automatica', $torneo->baja_por_impago_automatica),
