 ...
 * This is the ONLY place where permission names are defined.
...
final class PermissionEnum
{
    ...
    const MATCHES_RECORD_EVENTS      = 'matches.record_events';      // goals, cards
    const MATCHES_CONFIRM            = 'matches.confirm';             // delegate confirms
    const MATCHES_CONFIRM_ATTENDANCE = 'matches.confirm_attendance';  // player confirms
    ...
    const SANCTIONS_UPDATE = 'sanctions.update';
    const SANCTIONS_VOID   = 'sanctions.void';

    // ── Payments ────────────────────────────────────────
    const PAYMENTS_VIEW           = 'payments.view';
    const PAYMENTS_CREATE         = 'payments.create';
    const PAYMENTS_VERIFY         = 'payments.verify';
    ...
    /**
     * Return ALL permission names as a flat array.
     */
    ...
    /**
     * Group permissions by module for the admin UI.
     */
